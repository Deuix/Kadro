...
function buildUserPrompt(payload: Record<string, unknown>) {
  return [
    ...
    'Use format_detail when present to distinguish square feed posts, portrait feed posts, carousel slides, and stories. Never treat a feed post or carousel as a story unless format_detail explicitly indicates instagram_story.',
    ...
    'If output_type is carousel and preferred_image_aspect_ratio is 1:1, keep each slide concise enough for square layouts. If it is 4:5, allow slightly taller slide rhythm while staying compact.',
